...
public class Main {
	...
	public static void main(String[] args) {
		 ...
		 * Expected Output
		 * 
		 * Welcome to Admin Department Complete your documents submission Complete by
		 * EOD Today is not a Holiday
		 * 
		 * Welcome to HR Department team Lunch Fill today’s timesheet and mark your
		 * attendance Complete by EOD Today is not a Holiday
		 * 
		 * Welcome to Tech Department Complete coding of Module 1 Complete by EOD Core
		 * Java Today is not a Holiday
		 * 
		 * 
		 */
		...
		for (SuperDepartment department : departmentList) {
			...
			if (department instanceof TechDepartment) {
				// Cast the department to TechDepartment and call the getTechStackInformation
				// method
